...
print(paste("t critical value= ",round(t_critical,3)))
print(paste("t static value= ",round(t_stat,3)))
p_value=pnorm(t_stat)
if(t_stat>t_critical)
{
  print("Reject H0")
  print("weight lifting exercise make stronger")
}else
{
  print("Accept H0")
  print("weight lifting exercise does not make stronger")
}
dfs <- n-1
x <- seq(-5,5,0.1)
y <- dt(x,dfs)
