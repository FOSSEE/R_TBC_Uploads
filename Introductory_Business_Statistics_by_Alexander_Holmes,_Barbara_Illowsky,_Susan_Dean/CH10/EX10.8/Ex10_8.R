...
{
   print("Reject H0")
  print("mean age of democratic senators is > mean age of republican")
}else
{
  print("Accept H0")
  print("mean age of democratic senators is not > mean age of republican")
}
if(alpha>p_value)
{
  print("Reject H0")
