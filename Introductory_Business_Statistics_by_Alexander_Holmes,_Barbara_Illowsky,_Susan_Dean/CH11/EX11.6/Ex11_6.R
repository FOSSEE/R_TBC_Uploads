#apge no: 474-476
#H0 : distribution of TV is same
#H1 : distribution of TV is differen
...
print(paste("the test statistic =",round(t_stat,2)))
alpha=0.01
t_critical=qchisq(1-alpha,df=no-1)
print(paste("the critical value =",round(t_critical,3)))
