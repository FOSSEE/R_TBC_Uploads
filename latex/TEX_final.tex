...
\newcommand{\figref}[1]{Fig.~\ref{#1}}\title{R Textbook Companion for \\Probability, Statistics And Random Processes\\by Veerarajan T\footnote{Funded by a grant from the National Mission on Education through ICT - \href{http://spoken-tutorial.org/NMEICT-Intro}{http://spoken-tutorial.org/NMEICT-Intro}. This Textbook Companion and R codes written in it can be downloaded from the "Textbook Companion Project" section at the website - \href{https://r.fossee.in}{https://r.fossee.in}.}}
\author{ Created by \\Dikshita Mehta\\B.Tech.\\Computer Science and Engineering\\Vellore Institute of Technology, Chennai\\ Cross-Checked by \\R TBC Team\\}
\date{\today}
\begin{document}
\maketitle
...
\begin{description}
\item [Title:] Probability, Statistics And Random Processes
\item [Author:] Veerarajan T
\item [Publisher:] Tata Mcgraw-hill, New Delhi
\item [Edition:] 3
\item [Year:] 2008
\item [ISBN:] ISBN13: 978-0-07-066925-3
\end{description}
