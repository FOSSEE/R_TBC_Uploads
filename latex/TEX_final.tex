...
\newcommand{\figref}[1]{Fig.~\ref{#1}}\title{R Textbook Companion for \\Dummy Book Title For Testing\\by Dummy\footnote{Funded by a grant from the National Mission on Education through ICT - \href{http://spoken-tutorial.org/NMEICT-Intro}{http://spoken-tutorial.org/NMEICT-Intro}. This Textbook Companion and R codes written in it can be downloaded from the "Textbook Companion Project" section at the website - \href{https://r.fossee.in}{https://r.fossee.in}.}}
\author{ Created by \\Sashirekha\\B.Tech.\\Computer Science and Engineering\\FOSSEE\\ Cross-Checked by \\R TBC Team\\}
\date{\today}
\begin{document}
\maketitle
...
\begin{description}
\item [Title:] Dummy Book Title For Testing
\item [Author:] Dummy
\item [Publisher:] Mumbai
\item [Edition:] 5
\item [Year:] 2024
\item [ISBN:] 12345
\end{description}
