...
v<-(r-1)*(c-1);v
if(c_sq<12.6)print("HO may be accepted and intrpret that there is independent relatioship")else("H0 is rejected and conclude that there is evidence of a relatioship between undergraduate degree and MBA major")
