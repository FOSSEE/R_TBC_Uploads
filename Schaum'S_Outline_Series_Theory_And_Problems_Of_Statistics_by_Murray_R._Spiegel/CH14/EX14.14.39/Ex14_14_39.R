...
v1=y5+(g*x*sqrt(1+x7/(x1**2)))/(sqrt(f))
v2=(g*x*sqrt(1+x7/(x1**2)))/(sqrt(f))
v2=y5-v2
...
v3=y6+(g*x*sqrt(1+x4/(x1**2)))/(sqrt(f))
v4=(g*x*sqrt(1+x4/(x1**2)))/(sqrt(f))
v4=y6-v4
v3=round(v3,digits = 1)
v4=round(v4,digits = 1)
cat(v4,'kg',v3,'kg')
#"The answer may slightly vary due to rounding off values."
