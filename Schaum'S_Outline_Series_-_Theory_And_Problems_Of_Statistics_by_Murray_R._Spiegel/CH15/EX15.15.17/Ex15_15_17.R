...
r11=(r2-r1*r3)/sqrt((1-r1**2)*(1-r3**2))
r11=round(r11,digits = 4)
r11

r12=(r1-r2*r3)/sqrt((1-r2**2)*(1-r3**2))
r12=round(r12,digits = 4)
r12


r13=(r3-r1*r2)/sqrt((1-r1**2)*(1-r2**2))
r13=round(r13,digits = 4)
r13

r4=round(r11,digits = 2)
r4

r5=round(r12,digits = 2)
r5
